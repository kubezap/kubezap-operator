...
- [x] Basic reconciler (marks enabled triggers as Accepted)
...
- [ ] Kafka trigger (consumer integration)
- [ ] Flow CRD implementation (spec designed in docs/api/flow.md)
- [ ] FlowRun CRD implementation (spec designed in docs/api/flowrun.md)
- [ ] MockEndpoint CRD implementation (spec designed in docs/api/mock-endpoint.md)
- [ ] Integration CRD implementation (spec designed in docs/api/integration.md)
- [ ] Plugin protocol runtime (operator manages plugin Deployments, routes publish calls)
- [ ] Step CRD
- [ ] Helm chart
