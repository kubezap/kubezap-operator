...
cmd/kubezap/main.go
  ...
  → github.com/kubezap/kubezap-operator/internal/cli
      → github.com/kubezap/kubezap-operator/api/v1alpha1
...
builds:
  - id: kubezap-cli
    ...
    ldflags:
      - -s -w
      - -X github.com/kubezap/kubezap-operator/internal/cli.Version={{.Version}}
      - -X github.com/kubezap/kubezap-operator/internal/cli.GitCommit={{.ShortCommit}}
...
```bash
# Linux amd64
curl -Lo kubectl-kubezap https://github.com/kubezap/kubezap-operator/releases/latest/download/kubectl-kubezap_linux_amd64.tar.gz
