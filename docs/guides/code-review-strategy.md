...
3. **P0 findings block merge.** P1 findings get a schedule item filed before merge. P2 findings get a schedule item that can be deferred.
4. **Record findings in a tech-debt doc** (`docs/tech-debt/code-review-results-YYYY-MM-DD.md`) and add schedule items for P0/P1.

---

## References

- [FlowRun State Model](../architecture/flowrun-state-model.md)
