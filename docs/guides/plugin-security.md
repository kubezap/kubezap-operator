...
limitation. Controller-side mTLS for the publisher channel is on the roadmap and
is tracked in `docs/tech-debt/`. Until that ships, use a service mesh as described
above.
