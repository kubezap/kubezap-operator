...
| STORY-015 | [Write up results and a pursue/don't-pursue recommendation](stories/STORY-015-benchmark-writeup.md) | EPIC-004 | In Progress — PR #199 open | S |
...
| STORY-017 | [`goconst` cleanup in production code](stories/STORY-017-goconst-cleanup.md) | EPIC-002 | Done (landed directly on `main`, tracked historically as PR #198 — see follow-up in this PR's description) | M |
