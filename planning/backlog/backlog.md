...
| STORY-012 | [Docs for `WebhookGatewayConfig`](stories/STORY-012-webhookgatewayconfig-docs.md) | EPIC-003 | In Progress — [PR #202](https://github.com/kubezap/kubezap-operator/pull/202) open | S |
...
| STORY-019 | [Add missing `+kubebuilder:webhook` marker for FlowRun](stories/STORY-019-flowrun-webhook-marker.md) | EPIC-002 | In Progress — [PR #203](https://github.com/kubezap/kubezap-operator/pull/203) open | XS |
| STORY-020 | [Design record: sub-second FlowRun step-timing visibility](stories/STORY-020-flowrun-step-timing-precision-design.md) | EPIC-002 | In Progress — [PR #204](https://github.com/kubezap/kubezap-operator/pull/204) open | XS |
