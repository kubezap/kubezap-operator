...
- **Open-source positioning cleanup** (PR #175): MockEndpoint doc references removed, README "Why KubeZap" section, stale internal-naming artifacts removed from planning docs.
